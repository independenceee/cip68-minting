...
import { DocDocument, DocListItemProps } from "@/frontend/constants/docs";
            ...
            <div className="flex-1">
                ...
                >
                    ...
                    <div className="mt-3 flex items-center gap-4">
                        ...
                        <div className="text-sm text-gray-500">Updated: {new Date(document.lastUpdated).toLocaleDateString()}</div>
                    </div>
                </motion.div>
            </div>
