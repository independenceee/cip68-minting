...
export default function Page() {
    ...
    return (
        <div className=" text-white flex items-center justify-center p-6 min-h-[80vh]">
            <div className="text-center space-y-8 max-w-lg">
                ...
                <p className="text-base text-purple-300/80 italic">This feature is especially useful.</p>
            </div>
        </div>
    );
}
